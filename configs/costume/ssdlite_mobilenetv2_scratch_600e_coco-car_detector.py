...
log_config = dict(
    ...
    dict(type='MMDetWandbHook',
         init_kwargs={'project': 'Cars_Detector', 'entity': 'pumba', 'name': 'exp14'},
         interval=10,
         log_checkpoint=True,
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg = dict(
            type='Pretrained', 
            checkpoint='https://download.openmmlab.com/mmdetection/v2.0/ssd/ssdlite_mobilenetv2_scratch_600e_coco/ssdlite_mobilenetv2_scratch_600e_coco_20210629_110627-974d9307.pth', 
            prefix='backbone'),
    neck=dict(
        type='SSDNeck',
        in_channels=(96, 1280),
