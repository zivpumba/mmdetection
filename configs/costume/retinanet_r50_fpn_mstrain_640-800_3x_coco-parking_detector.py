...
#          init_kwargs={'project': 'Parking_Detector', 'entity': 'pumba', 'name': 'exp1'},
#          interval=10,
#          log_checkpoint=True,
...
classes = ('taken', 'available',)
images_prefix = '/home/ubuntu/Vision/images/merged_images'
annot_prefix = '/home/ubuntu/mmdetection/data/v4_0/jpg_multiC'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=f'{annot_prefix}/train.json',
            classes=classes,
            img_prefix=images_prefix)),
    val=dict(
        type=dataset_type,
        ann_file=f'{annot_prefix}/valid.json',
        classes=classes,
        img_prefix=images_prefix),
    test=dict(
        type=dataset_type,
        ann_file=f'{annot_prefix}/test.json',
        classes=classes,
        img_prefix=images_prefix))
